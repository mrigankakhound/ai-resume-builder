       ...
       <div className=''>
        ...
        <div className='border p-3 flex justify-between  text-white rounded-b-lg shadow-lg'
         style={{
          ...
          style={{color:'black'}}
          >{resume?.title || 'Title Not Available'}</h2>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel onClick={()=>setOpenAlert(false)} className='flex gap-2 bg-gray-200 text-black hover:bg-gray-400 hover:text-white'>Cancel</AlertDialogCancel>
